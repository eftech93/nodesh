...
function createTempDir() {
    const tempDir = path.join(__dirname, 'temp-console-test-' + Date.now());
...
describe('ExpressConsole', () => {
    ...
    describe('constructor', () => {
        it('should initialize with default options', () => {
            ...
            console = new console_1.ExpressConsole();
        ...
        it('should create an AppLoader instance', () => {
            console = new console_1.ExpressConsole({ rootPath: tempDir });
    ...
    describe('start', () => {
        it('should start the console', async () => {
            ...
            fs.writeFileSync(path.join(tempDir, 'models', 'Test.js'), 'module.exports = class Test {};');
            console = new console_1.ExpressConsole({
                rootPath: tempDir,
                forceExpress: true
            });
